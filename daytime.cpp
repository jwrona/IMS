...
void Daytime::Behavior(void)
{
	...
	Activate(Time + (OPENING_T - DAY_BEGIN_T));
    }
	...
	Activate(Time + (LUNCH_T - OPENING_T));
    }
	...
	Activate(Time + (LUNCH_END_T - LUNCH_T));
    }
	...
	Activate(Time + (DINNER_T - LUNCH_END_T));
    }
	...
	Activate(Time + (DINNER_END_T - DINNER_T));
    }
	...
	Activate(Time + (CLOSING_T - DINNER_END_T));
    }
	...
	Activate(Time + (DAY_END_T - CLOSING_T));
    }
    else
    {  //what did I miss?
        assert(false);
